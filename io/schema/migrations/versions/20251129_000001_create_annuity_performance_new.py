...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "reporting_month", sa.Date(), nullable=False, comment="Report date (月度)"
        ),
        # plan_code: Plan code identifier (计划代码)
        sa.Column(
            "plan_code", sa.String(255), nullable=False, comment="Plan code (计划代码)"
        ),
        # company_id: Company identifier - generated during enrichment
        sa.Column(
            "company_id", sa.String(50), nullable=False, comment="Company ID (公司标识)"
        ),
        ...
        sa.Column(
            ...
            sa.String(255),
            nullable=True,
            comment="Business type (业务类型)",
        ),
        sa.Column(
            "plan_type", sa.String(255), nullable=True, comment="Plan type (计划类型)"
        ),
        sa.Column(
            "plan_name", sa.String(255), nullable=True, comment="Plan name (计划名称)"
        ),
        ...
        sa.Column(
            ...
            sa.String(255),
            nullable=True,
            comment="Portfolio type (组合类型)",
        ),
        sa.Column(
            "portfolio_code",
            sa.String(255),
            nullable=True,
            comment="Portfolio code (组合代码)",
        ),
        sa.Column(
            "portfolio_name",
            sa.String(255),
            nullable=True,
            comment="Portfolio name (组合名称)",
        ),
        ...
        sa.Column(
            ...
            sa.String(255),
            nullable=True,
            comment="Institution code (机构代码)",
        ),
        sa.Column(
            "institution_name",
            sa.String(255),
            nullable=True,
            comment="Institution name (机构名称)",
        ),
        sa.Column(
            "product_line_code",
            sa.String(255),
            nullable=True,
            comment="Product line code (产品线代码)",
        ),
        ...
        sa.Column(
            ...
            sa.String(50),
            nullable=True,
            comment="Pension account number (年金账户号)",
        ),
        sa.Column(
            "pension_account_name",
            sa.String(255),
            nullable=True,
            comment="Pension account name (年金账户名)",
        ),
        # === Enterprise Group Information ===
        sa.Column(
            "sub_enterprise_number",
            sa.String(50),
            nullable=True,
            comment="Sub-enterprise number (子企业号)",
        ),
        sa.Column(
            "sub_enterprise_name",
            sa.String(255),
            nullable=True,
            comment="Sub-enterprise name (子企业名称)",
        ),
        sa.Column(
            "group_customer_number",
            sa.String(50),
            nullable=True,
            comment="Group enterprise customer number (集团企业客户号)",
        ),
        sa.Column(
            "group_customer_name",
            sa.String(255),
            nullable=True,
            comment="Group enterprise customer name (集团企业客户名称)",
        ),
        # === Audit Columns ===
        sa.Column(
            "pipeline_run_id",
            sa.String(50),
            nullable=True,
            comment="Pipeline execution ID for traceability",
        ),
        sa.Column(
            "created_at",
        ...
        sa.PrimaryKeyConstraint(
            ...
            "plan_code",
            "company_id",
            name="pk_annuity_performance_new",
        ),
        # CHECK constraints for non-negative asset values (AC-4.6.2)
        sa.CheckConstraint(
            "starting_assets >= 0", name="chk_starting_assets_non_negative"
        ),
...
def downgrade() -> None:
    ...
    # Drop indexes first
    op.drop_index(
        "idx_annuity_perf_new_pipeline_run", table_name="annuity_performance_new"
    )
    op.drop_index(
        "idx_annuity_perf_new_company_id", table_name="annuity_performance_new"
    )
    op.drop_index(
        "idx_annuity_perf_new_reporting_month", table_name="annuity_performance_new"
    )
