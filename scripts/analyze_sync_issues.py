"""深入分析 customer_plan_contract 同步问题
...
def main():
    ...
    print("=" * 70)
    print("深入分析 customer_plan_contract 同步问题")
    print("=" * 70)
    ...
    cur.execute("""
        ...
        FROM missing m
        LEFT JOIN customer."年金客户" cust ON m.company_id = cust.company_id
    ...
    for row in cur.fetchall():
        ...
        print(f"   - company_id={row[0][:20]}..., plan={row[1]}, product_line={row[2]} -> {reason}")
