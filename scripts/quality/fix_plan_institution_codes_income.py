#!/usr/bin/env python
"""
Fix institution codes and names in business."收入明细" for single plans.
...
def fix_institution_data(engine, plan_mapping, institution_name_mapping, dry_run=True):
    """
    Fix institution codes and names in business."收入明细".
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Fix institution codes and names in business.收入明细"
    )
    parser.add_argument(
        "--execute",
        action="store_true",
    ...
    print("=" * 80)
    print("修复 business.\"收入明细\" 机构代码和机构名称")
    print("=" * 80)
    print()
