...
-- Generation time: 2025-09-11 00:47:40
-- Configuration: with foreign keys
-- 
...
ALTER TABLE "规模明细" 
    ADD CONSTRAINT 规模明细_ibfk_1 
    FOREIGN KEY ("产品线代码") 
    REFERENCES "产品线"("产品线代码");
ALTER TABLE "规模明细" 
    ADD CONSTRAINT 规模明细_ibfk_2 
    FOREIGN KEY ("计划代码") 
    REFERENCES "年金计划"("年金计划号");
ALTER TABLE "规模明细" 
    ADD CONSTRAINT 规模明细_ibfk_3 
    FOREIGN KEY ("组合代码") 
    REFERENCES "组合计划"("组合代码");
ALTER TABLE "规模明细" 
    ADD CONSTRAINT 规模明细_ibfk_4 
    FOREIGN KEY ("机构代码") 
    REFERENCES "组织架构"("机构代码");
