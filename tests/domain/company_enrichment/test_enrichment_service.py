...
class TestCompanyEnrichmentServiceInitialization:
    ...
    def test_service_initialization_with_dependencies(self, mock_loader, mock_queue, mock_eqc_client):
    ...
    def test_service_initialization_default_budget(self, mock_loader, mock_queue, mock_eqc_client):
...
class TestInternalMappingResolution:
    ...
    def test_internal_mapping_hit_plan_code(self, enrichment_service, mock_loader, internal_mappings):
    ...
    def test_internal_mapping_hit_customer_name(self, enrichment_service, mock_loader, internal_mappings):
    ...
    def test_internal_mapping_hit_account_name(self, enrichment_service, mock_loader, internal_mappings):
...
class TestEQCSuccessWithCaching:
    ...
    def test_eqc_success_with_caching(self, enrichment_service, mock_loader, mock_eqc_client):
    ...
    def test_eqc_success_no_budget_queues_request(self, enrichment_service, mock_loader, mock_queue):
...
class TestBudgetExhaustionQueuing:
    ...
    def test_budget_exhaustion_queues_request(self, enrichment_service, mock_loader, mock_queue):
    ...
    def test_no_customer_name_and_no_internal_match_generates_temp_id(self, enrichment_service, mock_loader, mock_queue):
...
class TestTempIdGeneration:
    ...
    def test_empty_customer_name_generates_temp_id(self, enrichment_service, mock_loader, mock_queue):
        """Test empty customer_name generates TEMP_* ID."""
        mock_loader.load_mappings.return_value = []
    ...
    def test_queue_failure_fallback_to_temp_id(self, enrichment_service, mock_loader, mock_queue):
...
class TestEQCErrorHandling:
    ...
    def test_eqc_error_falls_back_to_queue(self, enrichment_service, mock_loader, mock_eqc_client, mock_queue):
    ...
    def test_eqc_timeout_error_graceful_handling(self, enrichment_service, mock_loader, mock_eqc_client, mock_queue):
    ...
    def test_eqc_no_results_queues_request(self, enrichment_service, mock_loader, mock_eqc_client, mock_queue):
...
class TestProcessLookupQueue:
    ...
    def test_process_lookup_queue_successful(self, enrichment_service, mock_queue, mock_eqc_client):
    ...
    def test_process_lookup_queue_eqc_failure(self, enrichment_service, mock_queue, mock_eqc_client):
    ...
    def test_process_lookup_queue_no_eqc_results(self, enrichment_service, mock_queue, mock_eqc_client):
...
class TestEdgeCasesAndValidation:
    ...
    def test_whitespace_handling_in_customer_name(self, enrichment_service, mock_loader):
        ...
        with patch('src.work_data_hub.domain.company_enrichment.service.resolve_company_id') as mock_resolve:
            ...
            enrichment_service.eqc_client.search_company.assert_called_once_with("Test Company")
    ...
    def test_internal_mapping_loader_error_continues_to_eqc(self, enrichment_service, mock_loader, mock_eqc_client):
