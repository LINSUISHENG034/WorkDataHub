...
The test uses the golden baseline generated by scripts/tools/run_legacy_annuity_performance_cleaner.py
...
def load_golden_baseline() -> pd.DataFrame:
    ...
    if not GOLDEN_BASELINE_PATH.exists():
        raise FileNotFoundError(
            ...
            f"Run: python scripts/tools/run_legacy_annuity_performance_cleaner.py "
