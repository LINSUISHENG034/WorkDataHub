...
class EQCClient(EQCTransport):
    ...
    def get_business_info_with_raw(self, company_id: str) -> Tuple[BusinessInfoResult, dict]:
        ...
        try:
            ...
            raise EQCClientError(f"Unexpected response structure from EQC findDepart API: {e}")
        return parsed, raw
    ...
    def _fetch_find_depart(self, company_id: str) -> Tuple[dict, dict]:
        ...
        try:
            ...
            if not business_info:
                ...
                raise EQCNotFoundError(f"No business information found for company: {cleaned_id}")
