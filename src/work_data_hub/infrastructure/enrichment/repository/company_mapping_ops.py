"""
Company mapping table operations mixin.

This module contains operations for the enterprise.company_mapping table.
...
class CompanyMappingOpsMixin:
    """Mixin providing company_mapping table operations."""
