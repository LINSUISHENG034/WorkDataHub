...
# AnnualAward column definitions
...
BronzeAnnualAwardSchema = pa.DataFrameSchema(
    columns={
        ...
        "中标日期": pa.Column(pa.DateTime, nullable=True, coerce=True),
    ...
    strict=False,  # Allow extra columns (区域, 年金中心, 上报人, etc. will be dropped)
    coerce=True,
)


GoldAnnualAwardSchema = pa.DataFrameSchema(
    columns={
        # Required fields
        ...
        "中标日期": pa.Column(pa.DateTime, nullable=True, coerce=True),
        "客户类型": pa.Column(pa.String, nullable=True, coerce=True),
        "受托人": pa.Column(pa.String, nullable=True, coerce=True),
        "计划规模": pa.Column(pa.Float, nullable=True, coerce=True),
        "年缴规模": pa.Column(pa.Float, nullable=True, coerce=True),
        "计划类型": pa.Column(pa.String, nullable=True, coerce=True),
        "证明材料": pa.Column(pa.String, nullable=True, coerce=True),
...
def validate_gold_dataframe(
    ...
    try:
        validated_df = GoldAnnualAwardSchema.validate(dataframe)
