"""
Pure transformation service for sandbox trustee performance data.

This module provides pure functions for transforming raw Excel data into
validated sandbox trustee performance domain objects. All functions are
...
class TrusteePerformanceTransformationError(Exception):
    """Raised when sandbox trustee performance data transformation fails."""
