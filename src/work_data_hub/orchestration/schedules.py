...
def _build_schedule_run_config() -> Dict[str, Any]:
    ...
    - Fixed domain: trustee_performance
...
def trustee_daily_schedule(_context):
    ...
    Runs at 02:00 Asia/Shanghai timezone to process trustee performance
    files using the multi-file job with production configuration:
    - Discovers trustee_performance files from configured directories
