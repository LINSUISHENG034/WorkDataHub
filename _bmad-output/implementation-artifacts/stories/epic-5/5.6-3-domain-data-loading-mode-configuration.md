...
- [x] `domain-migration/development-guide.md` updated with "Data Loading Mode Configuration" section
...
| `docs/guides/domain-migration/development-guide.md` | Added "Data Loading Mode Configuration" section |
...
- [Domain Development Guide - Data Loading Mode Configuration](../../guides/domain-migration/development-guide.md#data-loading-mode-configuration)
