...
class ConfigManager:
    ...
    def get_other_config(self):
        return {"api_endpoint": self.API_ENDPOINT, "debug_mode": self.DEBUG_MODE}

    def get_access_driver_config(self):
        return {"access_driver": self.ACCESS_DRIVER}
    ...
    def get_qcc_cookie(is_manual=False):
        ...
        # 检查响应状态码并获取 Cookie
            ...
            raise Exception(
                f"Failed to retrieve cookies from {url}. Status code: {response.status_code}"
            )
