...
| 2025-11-28 | 3.2 | 3.2 | Code Quality | High | TBD | Open | Fix test design: Remove tests that expect success for ambiguous matches [tests/unit/io/connectors/test_file_pattern_matcher.py:93-109] |
| 2025-11-28 | 3.2 | 3.2 | Code Quality | High | TBD | Open | Add proper ambiguous match test scenarios that expect DiscoveryError [tests/unit/io/connectors/test_file_pattern_matcher.py] |
| 2025-11-28 | 3.2 | 3.2 | Code Quality | High | TBD | Open | Fix performance test logic to match acceptance criteria [tests/unit/io/connectors/test_file_pattern_matcher.py:124-143] |
| 2025-11-28 | 3.2 | 3.2 | Code Quality | Medium | TBD | Open | Add comprehensive error validation tests for all DiscoveryError scenarios [tests/unit/io/connectors/test_file_pattern_matcher.py] |
| 2025-11-28 | 3.2 | 3.2 | Code Quality | Medium | TBD | Open | Fix integration test design issues [tests/integration/io/test_file_pattern_matching.py:95-183] |
