...
├── bmm-source-tree-analysis.md # Codebase structure analysis
│
├── architecture-patterns/     # Architecture patterns & guides
├── sprint-artifacts/          # Sprint planning & stories
├── domains/                   # Domain-specific documentation
├── runbooks/                  # Operational runbooks
├── supplement/                # Supplementary technical docs
├── specific/                  # Feature-specific analysis
├── crystallization/           # Deep analysis documents
├── initial/                   # Initial research & validation
...
Start with [BMM Index](./bmm-index.md) - it contains complete project context, code structure, and all documentation links.
